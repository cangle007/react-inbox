...
storiesOf('ToolbarComponent', module)
  .add('All Messsage Selected', () =>
    <ToolbarComponent
      messages={seedData}
      selectedMessageCount={seedData.length}
    />
  )
  .add('Some Messages Selected', () =>
    <ToolbarComponent messages={seedData} selectedMessageCount={1} />
  )
  .add('No Messages Selected', () =>
    <ToolbarComponent messages={seedData} selectedMessageCount={0} />
  );
