...
storiesOf('MessageComponent', module)
  .add('Selected path', () =>
    <MessageComponent selected={true} message={seedData[1]} />
  )
  .add('Unread path', () =>
    <MessageComponent selected={false} message={seedData[4]} />
  )
  .add('Read path', () =>
    <MessageComponent selected={false} message={seedData[6]} />
  )
  .add('Starred path', () =>
    <MessageComponent selected={false} message={seedData[1]} />
  )
  .add('Labels', () =>
    <MessageComponent selected={false} message={seedData[0]} />
  );
